...
export function CartProvider({ children }: CartProviderProps){
    ...
    function addSnackIntoCart(snack: SnackData): void {
        ...
        if(snackExistentInCart) {
            ...
            toast.success(`Outro(a) ${snackEmoji(snack.snack)} ${snack.name} adcionado nos pedidos!`)
            saveCart(newCart)
        ...
        toast.success(`${snackEmoji(snack.snack)} ${snack.name} adcionado nos pedidos!`)
        saveCart(newCart)
    }

    function removeSnackFromCart(snack: SnackData): void {
